export const policyCommitmentsData = {
  hero: {
    title: "POLICY COMMITMENTS",
    subtitle: "Transparency, Accountability, Sustainability.",
  ...
  principlesTable: {
    ...
    rows: [
      ...
      ["2: Human Rights — Non-Complicity", "7: Environment — Precautionary Approach"],
      ["3: Labour — Freedom of Association", "8: Environment — Greater Responsibility"],
      ["4: Labour — Elimination of Forced Labour", "9: Environment — Environmentally Friendly Technologies"],
      ["5: Labour — Abolition of Child Labour", "10: Anti-Corruption — Work Against Corruption"],
    ]
  },
  reporting: {
    ...
    policies: [
      {
        ...
        description: "We are committed to reducing our environmental footprint across all manufacturing operations. ECL holds ISO 14001 (since 2004) and UKAS-accredited ISO 50001 for Energy Management. Our Srikalahasti Works recycles over 94% of process water."
      },
      {
        title: "Energy & Climate Policy",
        description: "ECL monitors and manages energy consumption across all plants, targeting year-on-year reduction in specific energy intensity and progressively increasing the share of renewable energy, consistent with our ISO 50001 framework."
      },
      {
        title: "Human Rights & Labour Policy",
        description: "ECL is certified to SA 8000 affirming our commitment to fair labour practices, safe working conditions, freedom of association, and zero tolerance for forced or child labour, in alignment with UN GC Principles 3–6."
      },
      {
        title: "Health & Safety Policy",
        description: "ECL has voluntarily implemented ISO 45001 covering all operations and all stakeholders across our factories and head office."
      },
      {
        title: "Anti-Corruption & Business Ethics Policy",
        description: "ECL maintains zero tolerance toward bribery, corruption, and conflicts of interest — consistent with UN GC Principle 10. All employees and partners are bound by our Code of Conduct."
      },
      {
        title: "Supply Chain Responsibility Policy",
        description: "We work with suppliers and contractors who share our commitment to ethical sourcing, environmental responsibility, and fair labour practices."
      },
      {
        title: "Stakeholder Engagement & Disclosure Policy",
        description: "Our sustainability reporting follows GRI Standards and is independently assured under ISAE 3000 by BSI. We comply with SEBI's BRSR framework as a listed company."
      }
    ]
  },
  credentialsTable: {
    ...
    rows: [
      ...
      ["GRI Standards", "Third-party assured Sustainability Report · GRI-aligned · Independently audited for accuracy and completeness"],
      ["BSI ISAE 3000", "Independent sustainability assurance · Places ECL among India's most credibly verified manufacturers"],
      ["BRSR", "Business Responsibility & Sustainability Reporting · SEBI-mandated disclosure for listed companies"],
      ["SA 8000", "Social Accountability — 9 dimensions · Cross-reference: Social Initiatives › Safety & Our Commitments"],
      ["ISO 45001", "Occupational Health & Safety · Cross-reference: Social Initiatives › Safety"]
    ]
  },
