    ...
    <>
      ...
      <section className="py-8 bg-gray-50">
        <div className={cstyles.containerLg}>
          <GridTwoSection
            data={policyCommitmentsData.globalCommitment}
      ...
      <section className="py-8 bg-gray-50">
        <div className={cstyles.containerLg}>
          ...
          <div className="text-[#545454] font-medium text-[clamp(14px,2.5vw,18px)] flex flex-col gap-4" dangerouslySetInnerHTML={{ __html: policyCommitmentsData.reporting.description }} />
        </div>
      </section>
