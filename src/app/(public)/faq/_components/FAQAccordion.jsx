...
const FAQItem = ({
    ...
    return (
        <div
            className={`overflow-hidden rounded-[16px] md:rounded-[16px] border bg-white transition-all duration-300 ${isOpen
        ...
        >
            <div
                className={`transition-all duration-300 ${isOpen ? "bg-[#0B4DA2] text-white" : "bg-white text-[#0B4DA2]"
                    }`}
            >
                <button
                    type="button"
...
text-base sm:text-lg md:text-xl font-bold tracking-wide ${isOpen
                    ...
                    <span className="flex-shrink-0 flex h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 items-center justify-center rounded-full border border-[#FACC15] bg-[#FACC15] text-[#0B4DA2]">
                        <FiChevronDown
                            style={{ strokeWidth: 4 }}
                            className={`text-sm sm:text-base transition-transform duration-300 ${isOpen ? "rotate-180" : ""
                                }`}
                        />
                    </span>
                </button>
