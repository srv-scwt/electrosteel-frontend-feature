export const paintsData = {
  ...
  ProductCategories: {
    ...
    card: [
      { title: "Primers", desc: "Provides superior adhesion, corrosion resistance, effective surface preparation, and long-term substrate protection.<br/><br/><strong>Applications:</strong><br/>Steel structures, pipelines, valves, fittings, fabrication units, foundries, and industrial equipment.", image: "/images/paint/product_categories/PRIMER 1.png" },
      { title: "Mid-Coats", desc: "Provides enhanced film build, improved barrier protection, superior inter-coat adhesion, and extended coating system life.<br/><br/><strong>Applications:</strong><br/>Water pipelines, sewage systems, storage tanks, process equipment, and industrial infrastructure.", image: "/images/paint/product_categories/MID COATS 1.png" },
      { title: "Top-Coats", desc: "Provides excellent finish, colour retention, gloss, weather resistance, abrasion resistance, and long-term durability.<br/><br/><strong>Applications:</strong><br/>Industrial structures, pipelines, machinery, equipment, water infrastructure, and external metal surfaces.", image: "/images/paint/product_categories/TOP COATS (2) 1.png" },
      { title: "Thinners", desc: "Provides optimised viscosity control, improved application properties, efficient equipment cleaning, and enhanced coating performance.<br/><br/><strong>Applications:</strong><br/>Epoxy coatings, PU coatings, general industrial painting, and maintenance applications.", image: "/images/paint/product_categories/EPOXY THINNER 1.png" },
