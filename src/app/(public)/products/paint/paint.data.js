export const paintsData = {
  ...
  ProductCategories: {
    ...
    card: [
      ...
      { title: "Mid-Coats", desc: "Provides enhanced film build, improved barrier protection, superior inter-coat adhesion, and extended coating system life.<br/><br/><strong>Applications:</strong><br/>Water pipelines, sewage systems, storage tanks, process equipment, and industrial infrastructure." },
      { title: "Top-Coats", desc: "Provides excellent finish, colour retention, gloss, weather resistance, abrasion resistance, and long-term durability.<br/><br/><strong>Applications:</strong><br/>Industrial structures, pipelines, machinery, equipment, water infrastructure, and external metal surfaces." },
      { title: "Thinners", desc: "Provides optimised viscosity control, improved application properties, efficient equipment cleaning, and enhanced coating performance.<br/><br/><strong>Applications:</strong><br/>Epoxy coatings, PU coatings, general industrial painting, and maintenance applications." },
      { title: "Speciality Coatings", desc: "Specialised protection for high-temperature environments, road safety applications, anti-rust treatment, marking systems, and industrial maintenance requirements." },
      { title: "Custom Solutions", desc: "We also develop paints based on customer requirements and specific industrial applications." }
    ]
  },
