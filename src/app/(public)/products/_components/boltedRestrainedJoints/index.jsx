...
const BoltedRestrainedJoints = ({ data, className = "", label }) => {
  return (
    <section className="bg-white !py-0">
      <div className={`${styles.containerLg} !py-0`}>
        <div className={styles.sectionContent}>
          <div className="w-full mb-6 h-[300px] md:h-[400px] lg:h-[500px] relative overflow-hidden rounded-xl">
            <Image
         ...
         <div className={`${style.tableWrapper} ${className}`}>
            {data?.tableMaintitle && (
              ...
              >
                <h4 className="!w-full !m-0 p-6">{data?.tableMaintitle}</h4>
              </div>
            )}
            <CommonTable
              ...
              borderRadiusClass="rounded-[16px] rounded-t-[0px]"
              rows={data?.rows}
            />
