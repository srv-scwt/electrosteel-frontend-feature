export const careerData = {
  hero: {
    title: "Career",
    banner: "/images/board/carrer_banner_large.jpg",
  },
  overview: {
  ...
  whyJoinUs: {
    ...
    checklist: [
      ...
      "Collaborate with industry experts and forward-thinking professionals.",
      "Grow your career in a culture that values learning, performance, and leadership.",
      "Contribute to sustainable solutions that create lasting value for communities worldwide."
    ],
      ...
      categories: [
        {
          ...
          functions: ["Production", "Quality Control", "R&D", "Maintenance", "Projects"]
        },
        {
          id: "finance",
          title: "Finance & Accounts",
          functions: ["Costing", "Budgeting", "MIS", "Taxation", "Audit"]
        },
        {
          id: "hr",
          title: "Human Resources",
          functions: ["Talent Acquisition", "L&D", "Employee Relations", "Compliance"]
        },
        {
          id: "sales",
          title: "Sales & Marketing",
          functions: ["Domestic Sales", "Export Sales", "Brand", "Digital", "PR"]
        },
        {
          id: "corpcomm",
          title: "Corporate Communications",
          functions: ["Branding", "PR", "Digital", "Content", "Internal Communications"]
        },
        {
          id: "it",
          title: "IT & Digital",
          functions: ["ERP", "Cybersecurity", "Digital Transformation"]
        }
      ]
    },
    whatWeLookFor: {
      ...
      checklist: [
        ...
        "Team orientation with the ability to work across functions and geographies",
        "Alignment with our values of integrity, excellence, and sustainability",
        "Passion for creating products and solutions that make a difference",
      ],
    },
    whatWeOffer: {
      title: "WHAT WE OFFER",
      checklist: [
        ...
        "Performance-linked incentives and recognition programmes",
        "Exposure to international operations and cross-border projects",
        "Access to Pragati — our flagship employee learning and development programme",
        "Safe, SA 8000-certified workplaces committed to human rights and dignity",
      ],
    },
  },
  khoj: {
    ...
    programmeHighlights: {
      ...
      table: {
        ...
        tableBody: [
          ["What is Khoj?", "Khoj is ECL's structured campus recruitment programme, designed to bring in high-potential fresh graduates and early-career professionals across engineering, management, finance, and communications disciplines."],
          ["Who Can Apply?", "Final-year students pursuing B.Tech, MBA, CA, B.Sc., B.A., B.Com., and other relevant disciplines from recognised universities and institutes across India."],
          ["Campus Presence", "We actively recruit from premier B Schools/Engineering Institutions (NAAC A, A+, A++ accredited) on all-India Basis."],
          ["Selection Process", "Merit based Selection → Aptitude Test or Group Discussion → Technical / Domain Interview → Final Offer. The process is merit-based, transparent, and designed to assess both technical and personal fit."],
        ],
      },
    },
    rolesOffered: {
  ...
  careerEnquiry: {
    title: "<h2>Reach Out to <span>Our Talent Team</span></h2>",
    description: "<p>Whether you are interested in a specific vacancy, wish to submit an unsolicited application, or have a question about career opportunities at Electrosteel Castings Limited &mdash; we'd love to hear from you.</p><p>Please fill in the enquiry form below, and a member of our HR team will get back to you within 5&ndash;7 working days.</p>",
  },
};
