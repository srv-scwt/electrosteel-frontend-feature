...
export async function generateMetadata() {
  return buildMetadataForPathname("/investors/policies");
}
const CATEGORY = "extra-policies";
...
const page = async ({ searchParams }) => {
  ...
  const policies = await getExtraInvestorResponse({
    category: CATEGORY,
    page: currentPage,
    limit,
  });
  ...
  const { sections, pagination } = policies.data ?? {};
