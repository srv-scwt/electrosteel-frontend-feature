...
export default function TransferDetails() {
  return (
    <div className="mx-auto max-w-[86.67vw] py-[clamp(15px,5.5vw,20px)] !pt-0">
      <div className={styles.sectionContent}>
        {/* MAIN TITLE */}
        <h2>
          {transferDetails.title1.split(" ").map((word, index) => {
            if (index === 0) {
              return word;
            }
        ...
        {transferDetails.sections.map((section, index) => (
          <div key={index}>
