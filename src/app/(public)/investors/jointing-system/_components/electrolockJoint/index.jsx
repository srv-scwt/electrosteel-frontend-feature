...
const ElectrolockJoint = () => {
  return (
    <section id='boltless-restrained-joint' className="">
      <div className={`${styles.containerLg} !pt-0`}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-8 lg:gap-12 items-start">
          ...
          <div className={styles.sectionContent}>
            <h2><span>Ductile Iron Fittings - Boltless Restrained Joint (Electrolock Joint)</span></h2>
...
export default ElectrolockJoint